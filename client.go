...
// are handled.
func Post(url, contentType string,cook string, body io.Reader) (resp *Response, err error) {
	return DefaultClient.Post(url, contentType,cook, body)
}
...
// See the Client.Do method documentation for details on how redirects
// are handled.
func (c *Client) Post(url, contentType string,cook string, body io.Reader) (resp *Response, err error) {
...
// See the Client.Do method documentation for details on how redirects
// are handled.
func PostForm(url string,cook string, data url.Values) (resp *Response, err error) {
	return DefaultClient.PostForm(url,cook, data)
}
...
// See the Client.Do method documentation for details on how redirects
// are handled.
func (c *Client) PostForm(url string,cook string, data url.Values) (resp *Response, err error) {
	return c.Post(url, "application/x-www-form-urlencoded", cook,strings.NewReader(data.Encode()))
}
